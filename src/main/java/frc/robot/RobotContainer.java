...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    return (precommands.alongWith(followBallPath).andThen(() -> drivetrain.resetSensors()).andThen(followGoalLeftPath.alongWith(raiseArm)).andThen(new TimedCommand(emptyCommand, 2)).andThen(new ConveyorCommand(conveyor))).alongWith(new ShooterCommand(shooter));
  }
